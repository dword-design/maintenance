...
export default {
  'out of date': async () => {
    ...
    await expect(self()).rejects.toThrow(/^The currently installed base version \(1\.0\.0\) differs from the live version \(\d.\d.\d\)\. Please upgrade @dword-design\/maintenance\.$/)
  },
  'up to date': async () => {
